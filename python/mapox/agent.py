...
class Agent(Protocol, Generic[AgentState]):
    def sample_actions(
        self, agent_state: AgentState, timestep: TimeStep, rng_key: jax.Array
    ) -> tuple[AgentState, jax.Array, jax.Array]: ...
...
class RandomAgent(Agent[None]):
    ...
    def sample_actions(
        self, agent_state: None, timestep: TimeStep, rng_key: jax.Array
    ) -> tuple[None, jax.Array, jax.Array]:
