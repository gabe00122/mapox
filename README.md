...
These environments were originally developed as part of https://github.com/gabe00122/jaxrl and contains a reference model on huggingface.
...
- `timestep.obs`: `(num_agents, view_w, view_h, 4)` uint16
- actions and `timestep.last_action`: `(num_agents,)` uint16
